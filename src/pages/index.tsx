  ...
  return (
    <Layout>
      ...
      <div
        className="
      flex items-center
      !mt-4 m-4 md:m-12 !mb-0 bg-gradient-to-r min-h-[75vh] from-teal-400 via-blue-500 to-indigo-600  animate-gradient-x md:p-6 rounded-xl"
      >
        <div className="max-w-4xl w-full space-y-8 mx-auto py-12">
          ...
          >
            ...
            <div className="flex flex-row flex-wrap items-center justify-center gap-4 mt-6">
              <a
                href="#demo"
                className="block bg-white/70 p-4 rounded-lg text-black backdrop-blur-lg w-full max-w-[200px] text-center transition-transform transform hover:scale-105"
                onClick={(e) => {
                  e.preventDefault();
              ...
              <Link
                ...
                target="_blank"
                className="block bg-white/10 p-4 rounded-lg text-white backdrop-blur-lg w-full max-w-[200px] text-center transition-transform transform hover:scale-105"
              >
                Get In Touch
              </Link>
            </div>
      ...
      <div className="pt-6 pb-24 px-6 lg:px-12" id="demo">
        <motion.div
          ...
          <section className="bg-white p-8 rounded-lg  text-neutral-800">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="text-center">
                ...
                <p>
                  Worked at Matrix VFX and Spectra VFX, delivering cutting-edge
                  visuals.
                </p>
              </div>
              <div className="text-center">
