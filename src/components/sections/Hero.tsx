  ...
  return (
    <div className="flex items-center  bg-gradient-to-br  relative overflow-hidden py-8 rounded-2xl  ">
      ...
      <Container className="flex md:flex-row flex-col gap-6 h-full w-full max-w-[2000px] mx-auto">
        <div className="md:w-2/3 w-full bg-gradient-to-br border border-stone-200 from-stone-50 to-stone-300 min-h-[40vh]  relative z-10 rounded-3xl flex py-12 p-4 md:p-12 flex-col justify-between gap-y-12">
          {/* <motion.div
        ...
        <div className="md:w-1/3 w-full flex flex-col min-h-[50vh] group">
          ...
          <div className="mt-4  border border-stone-400 bg-gradient-to-br from-stone-200 to-stone-400 rounded-2xl transition-all duration-300 flex flex-col justify-center p-4 flex-1">
            <Typography variant="small" className="text-stone-600 font-medium mb-2 text-sm">
              VP Short Films
            </Typography>
            <Typography variant="h2" className="text-stone-800 font-semibold text-3xl">
